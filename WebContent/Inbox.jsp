...
<body>   
    ...
    <div id="found-section" >
     ...
     {   String sender =rs.getString(1);
         ...
         String Secret_Key1 =rs.getString(3);
         String Secret_Key2 =rs.getString(4);
         String Secret_Key3 =rs.getString(5);
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>   <td width="300"><img width="200" height="200" alt="" src="<%=mergeimagepath%>"></td>
          ...
          <td width="150"><%=Secret_Key3 %></td>
             <td width="100"><a href="receiversplit.jsp?Secret_Key1=<%=Secret_Key1%>&&Secret_Key2=<%=Secret_Key2%>&&Secret_Key3=<%=Secret_Key3%>&&Filefullpath=<%=Filefullpath%>&&mergeimagepath=<%=mergeimagepath%>">Split</a></td></tr>
