        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" >
                <ul class="nav navbar-nav navbar-right">
                    <li><a ></a></li>
                     <li><a href="SenderLogin.jsp">LOGIN</a></li>
                      <li><a href="SenderRegister.jsp">REGISTER</a></li>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-10 col-md-offset-1 col-sm-12">
                    ...
                    <h2> </h2>
                     <br />
                 <h3>  <a href="#about-section">  <i class="fa fa-flask down-icon"></i> </a> </h3>
                    <br /><br />
                </div>
            </div>
   ...
   <div id="basic-info">
       <div class="container">
                ...
                <div class="col-md-8 col-md-offset-2 " >
                    <h1>Welcome User</h1>
                    <h4>
                      <span style="color: red"> Steganography </span> : The practice of concealing messages or information within other non-secret text or data.
                    </h4>
                </div>
            </div>
