...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
   <title>Receiver Split Page</title>
    <!--GOOGLE FONT -->
            ...
            <!-- ./ Main Heading-->
             <div class="row main-low-margin  text-center">
                ...
                <div class="col-md-12 col-sm-12 text-justify" >
                    ...
                    <%
                    System.out.println("Welcome receiversplit page");
                    ...
                    %>
                         ...
                         <div  class="form">
    		    <form id="contactform" action="receiversplit?Secret_Key1=<%=Secret_Key1%>&&Secret_Key2=<%=Secret_Key2%>&&Secret_Key3=<%=Secret_Key3%>&&Filefullpath=<%=Filefullpath%>&&mergeimagepath=<%=mergeimagepath%>" method="post"> 
    		
    		    <p class="contact"><label for="username">How Many Rows</label></p> 
    			<input id="username" name="rrow" placeholder="No Of Rows" required="" tabindex="3" type="text"> 
                
    			<p class="contact"><label for="password">How Many Colomns</label></p> 
    			<input type="text" name="rcol" placeholder="No of Colomns" required="" tabindex="1" type="text"> 
