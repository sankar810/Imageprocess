    ...
    <div id="pricing-section" >
        <div class="container" >
            ...
            <!-- ./ Main Heading-->
             ...
             <div  class="form">
    		<form id="contactform" action="SenderLogin" method="post"> 
    		
    		    <p class="contact"><label for="username">Enter username</label></p> 
    			<input id="username" name="username" placeholder="Username" required="" tabindex="3" type="text"> 
                
    			<p class="contact"><label for="password">Password</label></p> 
    			<input type="password" name="password" placeholder="password" required="" tabindex="1" type="text"> 
